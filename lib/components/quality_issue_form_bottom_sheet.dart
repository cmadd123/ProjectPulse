...
/// Bottom sheet for client to report quality issues (free fixes)
class QualityIssueFormBottomSheet extends StatefulWidget {
  final String projectId;
  final String? milestoneId; // Optional - can be empty for "General"
  final String? milestoneName;

  const QualityIssueFormBottomSheet({
    super.key,
  ...
  @override
  State<QualityIssueFormBottomSheet> createState() =>
      _QualityIssueFormBottomSheetState();
}

class _QualityIssueFormBottomSheetState
    extends State<QualityIssueFormBottomSheet> {
  ...
  Future<void> _submitQualityIssue() async {
    ...
    try {
      ...
      if (_selectedImage != null) {
        final storageRef = FirebaseStorage.instance.ref().child(
            'projects/${widget.projectId}/quality_issues/${DateTime.now().millisecondsSinceEpoch}.jpg');
      ...
      await NotificationService.sendQualityIssueReportedNotification(
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('✓ Quality issue reported! Contractor notified.'),
        ...
        child: SingleChildScrollView(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'e.g., Tile is crooked in bottom right corner',
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Quality issues are free fixes. Contractor will address this.',
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: _isSubmitting ? null : _submitQualityIssue,
